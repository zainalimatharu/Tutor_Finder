                ...
                <div className="nav-wrapper col l10 offset-l1 m10 offset-m1 s12" id="navwrapper">
                    ...
                    <div className="col l7 m8 s4">
                        <div className="col l4 m3 s4"  style={{padding: "13px 0px 0px 0px"}}>
                            ...
                            <div className="col l3 m2" style={{padding: "0px"}}>
                            {this.props.userStatus ? 
                                <NavLink to="/tutorportal"><p className="center-align" style={{margin: "0px", fontWeight: "450"}}>Your Profile</p></NavLink>
                           :""
                            }
                                </div>
                            <div className="col l3 m2 s4" style={{padding: "0px"}}>
                                <NavLink to="/portal"><p className="center-align" style={{margin: "0px", fontWeight: "450"}}>Tutors Portal</p></NavLink>
                            </div>
                        <div className="col l2 m2 s4" style={{padding: "0px"}}>
                            {this.props.userStatus ? 
                                <NavLink ><p onClick={this.onLogout} className="center-align" style={{margin: "0px", fontWeight: "450"}}>Logout</p></NavLink>
                                    : 
                                <NavLink to="/signin"><p className="center-align" style={{margin: "0px", fontWeight: "450"}}>Sign in</p></NavLink>
                            }
                        </div>
                    </div>
                </div>
