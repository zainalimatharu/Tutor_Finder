...
class Register extends Component {
    ...
    render() { 
        return (
            <div className="row" style={{marginTop: "30px", paddingBottom: "0px"}}>
                <div className="col l8 offset-l2 m10 offset-m1 s12" id="register">
                    ...
                    {/* <form> */}
                        ...
                        />
                        <p id="passwordlength" style={{margin: "0px 0px 22px 0px"}}>Select password with at least 8 characters</p>
